...
<CodeBlockTabs defaultValue="Next.js">
  ...
  <CodeBlockTab value="Tanstack Start">
    ```ts  title="src/routes/llms[.]txt.ts"
  ...
  <CodeBlockTab value="Waku">
    ```ts  title="pages/_api/llms.txt.ts"
    import { source } from '@/lib/source';
    import { llms } from 'fumadocs-core/source';
...
<CodeBlockTabs defaultValue="Next.js">
  ...
  <CodeBlockTab value="Waku">
    ```ts  title="pages/_api/llms-full.txt.ts"
    import { source } from '@/lib/source';
    import { getLLMText } from '@/lib/get-llm-text';
...
<img alt="AI Page Actions" src="__img0" />
...
<Tabs items="['AI SDK', 'Inkeep AI']">
  <Tab>
    <CodeBlockTabs defaultValue="npm" groupId="package-manager">
      ...
      <CodeBlockTab value="pnpm">
        ```bash
        pnpm dlx @fumadocs/cli add ai/openrouter
        ```
      </CodeBlockTab>

      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx @fumadocs/cli add ai/openrouter
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x @fumadocs/cli add ai/openrouter
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
  ...
  <Tab>
    <CodeBlockTabs defaultValue="npm" groupId="package-manager">
      ...
      <CodeBlockTab value="pnpm">
        ```bash
        pnpm dlx @fumadocs/cli add ai/inkeep
        ```
      </CodeBlockTab>

      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx @fumadocs/cli add ai/inkeep
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x @fumadocs/cli add ai/inkeep
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
