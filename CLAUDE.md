...
- **Where to create a new component file (pick exactly one):**
  ...
  - **`@openng/ui`** — Design-system primitives (button, badge, switch, logos, etc.) consumed by web and docs. Radix-based primitives (e.g. switch) live here; do not replace existing primitives when adding new ones.
