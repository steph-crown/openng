...
export function SearchAndShadcnSection() {
  ...
  return (
    <section className="mt-5 grid grid-cols-2 gap-5 max-[1000px]:grid-cols-1">
      <article className="grid content-start gap-[14px] overflow-hidden rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
        ...
        <div className="rounded-[10px] border border-[var(--color-border)] p-2.5">
          <p className="m-0 border-b border-[var(--color-border)] pb-2 text-[var(--color-muted)]">
            curl {holidaysMetaUrl}
          </p>
          <ul className="m-0 grid list-none gap-2.5 px-0 pb-0 pt-2.5">
            <li className="rounded-[7px] border border-[var(--color-border)] px-2.5 py-2">
              resource: holidays
            </li>
            <li className="rounded-[7px] border border-[var(--color-border)] px-2.5 py-2">
              record_count: 91
      ...
      <article className="grid grid-rows-[auto_1fr] overflow-hidden rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-[var(--color-surface)]">
